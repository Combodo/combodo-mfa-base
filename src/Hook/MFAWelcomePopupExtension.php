		...
		if (UserRights::IsAdministrator()) {
			if (class_exists('MFAUserSettingsWebAuthn')) {
				...
				$aMessages[] = MessageFactory::MakeForLeftIllustrationAsSVGMarkupRightTexts(
					'999_06_MFA',
					Dict::S('UI:WelcomePopup:Message:999_06_MFA:Title'),
					Dict::Format('UI:WelcomePopup:Message:999_06_MFA:Description', 'https://www.itophub.io/wiki/page?id=extensions:combodo-mfa-extended'),
				...
				$aMessages[] = MessageFactory::MakeForLeftIllustrationAsSVGMarkupRightTexts(
					'999_06_MFA',
					Dict::S('UI:WelcomePopup:Message:999_06_MFA:Title'),
					Dict::Format('UI:WelcomePopup:Message:999_06_MFA:Description', 'https://www.itophub.io/wiki/page?id=extensions:combodo-mfa-light'),
					utils::GetAbsoluteUrlModulesRoot().MFABaseHelper::MODULE_NAME.'/assets/img/illustrations/undraw_two_factor_authentication.svg'
				);
			}
		}
