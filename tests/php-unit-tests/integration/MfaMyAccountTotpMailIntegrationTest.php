 ...
 *
 */
class MfaMyAccountTotpMailIntegrationTest extends AbstractMFATest implements MFAAbstractConfigurationTestInterface {
	...
	public function testConfigurationFirstScreenDisplay()
	{
		...
		$this->AssertStringContains("<input type=\"text\" id=\"totp_code\"", $sOutput, 'The page should contain form to validate TOTP Mail code');
	}
