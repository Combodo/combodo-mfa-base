...
class MFAAdminRuleServiceTest extends AbstractMFATest
{
	...
	public function testGetValidRuleByUserId()
	{
		...
		$oOrgLessUser = $this->CreateContactlessUser('NoOrgUser', ItopDataTestCase::$aURP_Profiles['Service Desk Agent'], 'ABCdefg@12345#');
		$this->AssertRulesAreIdentical($oRule, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oOrgLessUser->GetKey()), 'Valid rule should be found');
	}
	...
	{
		$this->CreateRule("rule with Portal User in org1", "MFAUserSettingsTOTPMail", "forced", [$this->org1->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']], 1);
		$this->CreateRule("rule with Administrator", "MFAUserSettingsTOTPMail", "optional", [], [ItopDataTestCase::$aURP_Profiles['Administrator']], 2);

		$oOrgLessUser = $this->CreateContactlessUser("Agent", ItopDataTestCase::$aURP_Profiles['Service Desk Agent'], "ABCdefg@12345#");
		$this->assertEquals(null, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oOrgLessUser->GetKey()));

		$oPortalUserInOrg1 = $this->CreateUserWithProfilesAndOrg("PortalUserInOrg2", [$this->org2->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']]);
		$this->assertEquals(null, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oPortalUserInOrg1->GetKey()));
		...
		$this->assertEquals(null, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oAgentInOrg1->GetKey()));
	}
	...
	public function testMatchingRule_Org()
	{
		...
		$oRule4 = $this->CreateRule("testMatchingRule_Org".$i++, "MFAUserSettingsTOTPMail", "forced", [$this->org2->GetKey()], [], 10);
		$oRule5 = $this->CreateRule("testMatchingRule_Org".$i++, "MFAUserSettingsTOTPMail", "optional", [$this->org2->GetKey()], [], 5);
		$oRule6 = $this->CreateRule("testMatchingRule_Org".$i++, "MFAUserSettingsTOTPMail", "forced", [$this->org2->GetKey()], [], 7);
		...
		$oOrgLessUser = $this->CreateContactlessUser("OrgLessAgent", ItopDataTestCase::$aURP_Profiles['Service Desk Agent'], "ABCdefg@12345#");
		$this->AssertRulesAreIdentical($oRule5, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oOrgLessUser->GetKey()));

		$oPortalUserInOrg2 = $this->CreateUserWithProfilesAndOrg("PortalUserInOrg2", [$this->org2->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']]);
		$this->AssertRulesAreIdentical($oRule5, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oPortalUserInOrg2->GetKey()));
		...
		$this->AssertRulesAreIdentical($oRule3, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oPortalUserInOrg1->GetKey()));
	...
	public function testMatchingRule_ProfileAndOrg()
	{
		...
		$oRule4 = $this->CreateRule("testMatchingRule_ProfileAndOrg".$i++, "MFAUserSettingsTOTPMail", "forced", [$this->org2->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']], 10);
		$oRule5 = $this->CreateRule("testMatchingRule_ProfileAndOrg".$i++, "MFAUserSettingsTOTPMail", "optional", [$this->org2->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']], 5);
		$oRule6 = $this->CreateRule("testMatchingRule_ProfileAndOrg".$i++, "MFAUserSettingsTOTPMail", "optional", [$this->org2->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']], 7);
		...
		$oOrgLessUser = $this->CreateContactlessUser("OrgLessAgent", ItopDataTestCase::$aURP_Profiles['Service Desk Agent'], "ABCdefg@12345#");
		$this->AssertRulesAreIdentical($oNoProfileNoOrgRule1, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oOrgLessUser->GetKey()));

		$oPortalUserInOrg2 = $this->CreateUserWithProfilesAndOrg("PortalUserInOrg2", [$this->org2->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']]);
		$this->AssertRulesAreIdentical($oRule5, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oPortalUserInOrg2->GetKey()));

		$oPortalUserInOrg1 = $this->CreateUserWithProfilesAndOrg("PortalUserInOrg1", [$this->org1->GetKey()], [ItopDataTestCase::$aURP_Profiles['Portal user']]);
		$this->AssertRulesAreIdentical($oRule2, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oPortalUserInOrg1->GetKey()));
	}
	...
	public function testMatchingRule_Profile()
	{
		...
		$oRule4 = $this->CreateRule("testMatchingRule_Profile".$i++, "MFAUserSettingsTOTPMail", "forced", [], $aWith1profiles, 10);
		$oRule5 = $this->CreateRule("testMatchingRule_Profile".$i++, "MFAUserSettingsTOTPMail", "optional", [], $aWith1profiles, 5);
		$oRule6 = $this->CreateRule("testMatchingRule_Profile".$i++, "MFAUserSettingsTOTPMail", "optional", [], $aWith1profiles, 7);
		...
		$oOrgLessUser = $this->CreateContactlessUser("OrgLessAgent", ItopDataTestCase::$aURP_Profiles['Service Desk Agent'], "ABCdefg@12345#");
		$this->AssertRulesAreIdentical($oNoProfileRule1, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oOrgLessUser->GetKey()));
		...
		$this->AssertRulesAreIdentical($oRule5, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oPortalUser->GetKey()));

		$oAdminUser = $this->CreateUserWithProfilesAndOrg("adminUser".$i++, [$this->org2->GetKey()], [ItopDataTestCase::$aURP_Profiles['Administrator']]);
		$this->AssertRulesAreIdentical($oRule3, MFAAdminRuleService::GetInstance()->GetAdminRuleByUserId($oAdminUser->GetKey()));
	...
	public function AssertRulesAreIdentical($oExpectedRule, ?MFAAdminRule $oRule, $sMessage = ''): void
	{
		if (is_null($oExpectedRule)) {
			$this->assertNull($oRule, $sMessage);
		} else {
			$this->assertEquals($oExpectedRule->Get('preferred_mfa_mode'), $oRule->Get('preferred_mfa_mode'), $sMessage);
			$this->assertEquals($oExpectedRule->Get('name'), $oRule->Get('name'), $sMessage);
		}
	}
