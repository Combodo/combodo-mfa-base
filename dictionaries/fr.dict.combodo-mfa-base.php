...
<div><a href="%1$s" target="_blank">En savoir plus</a></div>',
	...
	'Login:MFA:UserWarningAboutMFAMode:Explain' => 'Le mode d\'authentification multifacteur %1$s doit être activé avant %2$s. Après cette date, la configuration MFA sera obligatoire.',
	...
	'Class:MFAAdminRule/Attribute:denied_mfamodes_list' => 'Modes refusés',
	'Class:MFAAdminRule/Attribute:denied_mfamodes_list+' => 'Liste des modes refusés qui ne seront pas disponibles pour les utilisateurs concernés',
